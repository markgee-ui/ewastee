...
<head>
    ...
    <title>Consumer Dashboard - Etaka</title>
...
<body class="bg-gray-100/50">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p id="user-role" class="text-xs text-gray-500 capitalize">Consumer</p>
                        </div>
                    </div>
                </div>
            </header>
    ...
    <script type="module" src="{{ secure_asset('js/consumer-dashboard.js') }}"></script>
</body>
</html>
