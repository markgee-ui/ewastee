...
document.addEventListener('DOMContentLoaded', () => {
    ...
    /**
     * Handles the submission of a new e-waste request by a consumer.
    ...
    function handleRequestSubmit(e) {
        ...
        const newRequest = {
            /**
             * The ID of the new request, which is the maximum ID of the existing requests plus one.
             */
            id: ewasteRequests.length > 0 ? Math.max(...ewasteRequests.map(r => r.id)) + 1 : 1,
            /**
             * The ID of the consumer who submitted the request.
             */
            consumer_id: state.currentUser.id,
            /**
             * The ID of the recycler assigned to the request, which is null for now.
             */
            recycler_id: null,
            /**
             * The type of e-waste included in the request.
             */
            type: document.getElementById('type').value,
            /**
             * The quantity of e-waste included in the request.
             */
            quantity: parseInt(document.getElementById('quantity').value, 10),
            /**
             * The location where the e-waste will be picked up.
             */
            pickup_location: document.getElementById('pickup_location').value,
            /**
             * A description of the e-waste included in the request.
             */
            description: document.getElementById('description').value,
            /**
             * The status of the request, which is initially "pending".
             */
            status: 'pending'
        };
